        ...
        <Fragment>
            <Grid container spacing={3}>
                                    ...
                                    return (
                                        <Fragment key={data.id}>
                                            ...
                                            <Grid item xs={12} sm={12} md={7} lg={7} xl={7}>
                                                ...
                                                <div>
                                                    <p style={{ fontSize: '14px', height: '50px' }} dangerouslySetInnerHTML={{ __html: data.excerpt.rendered }} />
                                                </div>
                ...
                <Grid item xs={12} sm={5}>
                    <Box style={{ height: '100%', marginTop: '30px', border:'1px solid grey', display:'flex', justifyContent:'center', alignItems:'center' }}>
                    <h3>SPACE IKLAN</h3>
                    </Box>
                </Grid>
            </Grid>
